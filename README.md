...
The GitHub Actions workflow in `.github/workflows/build-anyuagent-macos.yml` builds unsigned macOS `arm64` and `x64` DMG/ZIP artifacts. Pushing a version tag such as `v1.0.16` also publishes those four files to a GitHub Release.

### macOS downloads

1. Open the repository's **Releases** page.
2. Download `AnYuAgent-1.0.16-arm64.dmg` for Apple Silicon, or `AnYuAgent-1.0.16-x64.dmg` for Intel Macs.
